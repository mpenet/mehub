...
hiccups.runtime.character_escapes = cljs.core.HashMap.fromArrays(["&", "<", ">", '"'], ["&amp;", "&lt;", "&gt;", "&quot;"]);
hiccups.runtime.container_tags = cljs.core.set("dd,head,a,b,body,pre,form,iframe,dl,em,fieldset,i,h1,h2,span,h3,script,html,h4,h5,h6,table,dt,div,style,label,option,ul,strong,canvas,textarea,li,ol".split(","));
hiccups.runtime.as_str = function(a) {
  return cljs.core.truth_(function() {
    var b = cljs.core.keyword_QMARK_.call(null, a);
    return cljs.core.truth_(b) ? b : cljs.core.symbol_QMARK_.call(null, a)
  }()) ? cljs.core.name.call(null, a) : cljs.core.str.call(null, a)
};
...
hiccups.runtime.xml_attribute = function(a, b) {
  return cljs.core.str.call(null, " ", hiccups.runtime.as_str.call(null, a), '="', hiccups.runtime.escape_html.call(null, b), '"')
};
hiccups.runtime.render_attribute = function(a) {
  var b = cljs.core.nth.call(null, a, 0, null), a = cljs.core.nth.call(null, a, 1, null);
  return cljs.core.truth_(!0 === a) ? cljs.core.truth_(hiccups.runtime.xml_mode_QMARK_.call(null)) ? hiccups.runtime.xml_attribute.call(null, b, b) : cljs.core.str.call(null, " ", hiccups.runtime.as_str.call(null, b)) : cljs.core.truth_(cljs.core.not.call(null, a)) ? "" : cljs.core.truth_("\ufdd0'else") ? hiccups.runtime.xml_attribute.call(null, b, a) : null
};
...
hiccups.runtime.normalize_element = function(a) {
  ...
  var d = cljs.core.nth.call(null, c, 1, null), e = cljs.core.nth.call(null, c, 2, null), c = cljs.core.nth.call(null, c, 3, null), e = cljs.core.ObjMap.fromObject(["\ufdd0'id", "\ufdd0'class"], {"\ufdd0'id":e, "\ufdd0'class":cljs.core.truth_(c) ? c.replace(".", " ") : null}), c = cljs.core.first.call(null, a);
  return cljs.core.truth_(cljs.core.map_QMARK_.call(null, c)) ? cljs.core.PersistentVector.fromArray([d, cljs.core.merge.call(null, e, c), cljs.core.next.call(null, a)]) : cljs.core.PersistentVector.fromArray([d, e, a])
};
hiccups.runtime.render_element = function(a) {
  ...
  return cljs.core.truth_(cljs.core.truth_(b) ? b : hiccups.runtime.container_tags.call(null, a)) ? cljs.core.str.call(null, "<", a, hiccups.runtime.render_attr_map.call(null, c), ">", hiccups.runtime.render_html.call(null, b), "</", a, ">") : cljs.core.str.call(null, "<", a, hiccups.runtime.render_attr_map.call(null, c), hiccups.runtime.end_tag.call(null))
};
hiccups.runtime.render_html = function render_html(b) {
  return cljs.core.truth_(cljs.core.vector_QMARK_.call(null, b)) ? hiccups.runtime.render_element.call(null, b) : cljs.core.truth_(cljs.core.seq_QMARK_.call(null, b)) ? cljs.core.apply.call(null, cljs.core.str, cljs.core.map.call(null, render_html, b)) : cljs.core.truth_("\ufdd0'else") ? hiccups.runtime.as_str.call(null, b) : null
};
var jayq = {util:{}};
...
var mehub = {module:{}};
mehub.module.PModule = {};
mehub.module.setup = function() {
  var a = null;
  return function(a, c) {
    switch(arguments.length) {
      case 1:
        var d;
        if(cljs.core.truth_(cljs.core.truth_(a) ? a.mehub$module$PModule$setup : a)) {
          d = a.mehub$module$PModule$setup(a)
        }else {
          d = mehub.module.setup[goog.typeOf.call(null, a)];
          if(!cljs.core.truth_(d) && (d = mehub.module.setup._, !cljs.core.truth_(d))) {
            throw cljs.core.missing_protocol.call(null, "PModule.setup", a);
          }
          d = d.call(null, a)
        }
        return d;
      case 2:
        if(cljs.core.truth_(cljs.core.truth_(a) ? a.mehub$module$PModule$setup : a)) {
          d = a.mehub$module$PModule$setup(a, c)
        }else {
          d = mehub.module.setup[goog.typeOf.call(null, a)];
          if(!cljs.core.truth_(d) && (d = mehub.module.setup._, !cljs.core.truth_(d))) {
            throw cljs.core.missing_protocol.call(null, "PModule.setup", a);
...
mehub.module.load_module = function() {
  ...
  return new cljs.core.MultiFn("load-module", function(a) {
    return a
  }, "\ufdd0'default", e, a, b, c, d)
}();
cljs.core._add_method.call(null, mehub.module.load_module, "\ufdd0'default", function() {
  return null
});
jayq.core = {};
...
mehub.module.twitter = {};
mehub.module.twitter.pad = function(a) {
  return cljs.core.truth_(10 > a) ? cljs.core.str.call(null, "0", a) : a
};
mehub.module.twitter.to_ircish_date = function(a) {
  a = new Date(a);
  return cljs.core.str.call(null, mehub.module.twitter.pad.call(null, a.getMonth() + 1), ".", mehub.module.twitter.pad.call(null, a.getUTCDay() + 1), "@", a.getUTCHours(), ":", a.getUTCMinutes())
};
mehub.module.twitter.tweets_template = function(a) {
  return cljs.core.str.call(null, "<ul", ' class="tweets"', ">", cljs.core.apply.call(null, cljs.core.str, function() {
    return function c(a) {
      return new cljs.core.LazySeq(null, !1, function() {
        for(;;) {
          if(cljs.core.truth_(cljs.core.seq.call(null, a))) {
            var e = cljs.core.first.call(null, a);
            return cljs.core.cons.call(null, cljs.core.str.call(null, "<li", "", ">", function() {
              var a = cljs.core.str.call(null, "[", mehub.module.twitter.to_ircish_date.call(null, "\ufdd0'created_at".call(null, e)), "] ");
              return cljs.core.truth_(cljs.core.map_QMARK_.call(null, a)) ? cljs.core.str.call(null, "<span", hiccups.runtime.render_attr_map.call(null, cljs.core.merge.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'id", "\ufdd0'class"], {"\ufdd0'id":null, "\ufdd0'class":"timestamp"}), a)), ">", "</span>") : cljs.core.str.call(null, '<span class="timestamp">', hiccups.runtime.render_html.call(null, a), "</span>")
            }(), function() {
              var a = "\ufdd0'text".call(null, e);
              return cljs.core.truth_(cljs.core.map_QMARK_.call(null, a)) ? cljs.core.str.call(null, "<span", hiccups.runtime.render_attr_map.call(null, cljs.core.merge.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'id", "\ufdd0'class"], {"\ufdd0'id":null, "\ufdd0'class":"text"}), a)), ">", "</span>") : cljs.core.str.call(null, '<span class="text">', hiccups.runtime.render_html.call(null, a), "</span>")
            }(), "</li>"), c.call(null, cljs.core.rest.call(null, a)))
          }
          return null
        }
      })
...
mehub.module.twitter.header_template = function(a) {
  return cljs.core.str.call(null, "<h2", "", ">", "<a", hiccups.runtime.render_attr_map.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'href", "\ufdd0'id", "\ufdd0'class"], {"\ufdd0'href":cljs.core.str.call(null, "http://twitter.com/", a), "\ufdd0'id":null, "\ufdd0'class":null})), ">", hiccups.runtime.render_html.call(null, cljs.core.str.call(null, "> ", a, "@twitter")), "</a>", "</h2>")
};
mehub.module.twitter.load_tweets = function(a, b, c) {
  return jQuery.getJSON(cljs.core.str.call(null, "http://api.twitter.com/1/statuses/user_timeline.json?", "count=", b, "&screen_name=", encodeURIComponent.call(null, a), "&callback=?"), function(a) {
    return c.call(null, cljs.core.js__GT_clj.call(null, a, "\ufdd0'keywordize-keys", !0))
  })
};
mehub.module.twitter.render_tweets = function(a, b) {
  return jayq.core.append.call(null, jayq.core.$.call(null, a), mehub.module.twitter.tweets_template.call(null, b))
};
mehub.module.twitter.render_header = function(a, b) {
  return jayq.core.inner.call(null, jayq.core.$.call(null, a), mehub.module.twitter.header_template.call(null, b))
};
mehub.module.twitter.TwitterModule = function(a, b, c) {
  this.options = a;
  this.__meta = b;
  this.__extmap = c;
  1 < arguments.length ? (this.__meta = b, this.__extmap = c) : this.__extmap = this.__meta = null
};
mehub.module.twitter.TwitterModule.prototype.cljs$core$IHash$ = !0;
mehub.module.twitter.TwitterModule.prototype.cljs$core$IHash$_hash = function(a) {
  return cljs.core.hash_coll.call(null, a)
};
mehub.module.twitter.TwitterModule.prototype.cljs$core$ILookup$ = !0;
mehub.module.twitter.TwitterModule.prototype.cljs$core$ILookup$_lookup = function() {
  var a = null;
  return function(a, c, d) {
    switch(arguments.length) {
      case 2:
        return cljs.core._lookup.call(null, a, c, null);
      case 3:
        return cljs.core.truth_("\ufdd0'options" === c) ? this.options : cljs.core.truth_("\ufdd0'else") ? cljs.core.get.call(null, this.__extmap, c, d) : null
    }
    throw"Invalid arity: " + arguments.length;
  }
}();
mehub.module.twitter.TwitterModule.prototype.cljs$core$IAssociative$ = !0;
mehub.module.twitter.TwitterModule.prototype.cljs$core$IAssociative$_assoc = function(a, b, c) {
  return cljs.core.truth_(cljs.core.identical_QMARK_.call(null, "\ufdd0'options", b)) ? new mehub.module.twitter.TwitterModule(c, this.__meta, this.__extmap) : new mehub.module.twitter.TwitterModule(this.options, this.__meta, cljs.core.assoc.call(null, this.__extmap, b, c))
};
mehub.module.twitter.TwitterModule.prototype.cljs$core$IRecord$ = !0;
mehub.module.twitter.TwitterModule.prototype.cljs$core$ICollection$ = !0;
mehub.module.twitter.TwitterModule.prototype.cljs$core$ICollection$_conj = function(a, b) {
  return cljs.core.truth_(cljs.core.vector_QMARK_.call(null, b)) ? cljs.core._assoc.call(null, a, cljs.core._nth.call(null, b, 0), cljs.core._nth.call(null, b, 1)) : cljs.core.reduce.call(null, cljs.core._conj, a, b)
};
mehub.module.twitter.TwitterModule.prototype.mehub$module$PModule$ = !0;
mehub.module.twitter.TwitterModule.prototype.mehub$module$PModule$setup = function() {
  mehub.module.twitter.render_header.call(null, "\ufdd0'selector".call(null, this.options), "\ufdd0'user".call(null, this.options));
  return mehub.module.twitter.load_tweets.call(null, "\ufdd0'user".call(null, this.options), "\ufdd0'max-tweets".call(null, this.options), cljs.core.partial.call(null, mehub.module.twitter.render_tweets, "\ufdd0'selector".call(null, this.options)))
};
mehub.module.twitter.TwitterModule.prototype.cljs$core$ISeqable$ = !0;
mehub.module.twitter.TwitterModule.prototype.cljs$core$ISeqable$_seq = function() {
  return cljs.core.seq.call(null, cljs.core.concat.call(null, cljs.core.PersistentVector.fromArray([cljs.core.vector.call(null, "\ufdd0'options", this.options)]), this.__extmap))
};
mehub.module.twitter.TwitterModule.prototype.cljs$core$IPrintable$ = !0;
mehub.module.twitter.TwitterModule.prototype.cljs$core$IPrintable$_pr_seq = function(a, b) {
  return cljs.core.pr_sequential.call(null, function(a) {
    return cljs.core.pr_sequential.call(null, cljs.core.pr_seq, "", " ", "", b, a)
  }, cljs.core.str.call(null, "#", "mehub.module.twitter.TwitterModule", "{"), ", ", "}", b, cljs.core.concat.call(null, cljs.core.PersistentVector.fromArray([cljs.core.vector.call(null, "\ufdd0'options", this.options)]), this.__extmap))
};
mehub.module.twitter.TwitterModule.prototype.cljs$core$ICounted$ = !0;
mehub.module.twitter.TwitterModule.prototype.cljs$core$ICounted$_count = function() {
  return 1 + cljs.core.count.call(null, this.__extmap)
};
mehub.module.twitter.TwitterModule.prototype.cljs$core$IEquiv$ = !0;
mehub.module.twitter.TwitterModule.prototype.cljs$core$IEquiv$_equiv = function(a, b) {
  var c = a.constructor === b.constructor;
  return cljs.core.truth_(c) ? cljs.core.equiv_map.call(null, a, b) : c
};
mehub.module.twitter.TwitterModule.prototype.cljs$core$IWithMeta$ = !0;
mehub.module.twitter.TwitterModule.prototype.cljs$core$IWithMeta$_with_meta = function(a, b) {
  return new mehub.module.twitter.TwitterModule(this.options, b, this.__extmap)
};
mehub.module.twitter.TwitterModule.prototype.cljs$core$IMeta$ = !0;
mehub.module.twitter.TwitterModule.prototype.cljs$core$IMeta$_meta = function() {
  return this.__meta
};
mehub.module.twitter.TwitterModule.prototype.cljs$core$IMap$ = !0;
mehub.module.twitter.TwitterModule.prototype.cljs$core$IMap$_dissoc = function(a, b) {
  return cljs.core.truth_(cljs.core.contains_QMARK_.call(null, cljs.core.set(["\ufdd0'options"]), b)) ? cljs.core.dissoc.call(null, cljs.core.with_meta.call(null, cljs.core.into.call(null, cljs.core.ObjMap.fromObject([], {}), a), this.__meta), b) : new mehub.module.twitter.TwitterModule(this.options, this.__meta, cljs.core.not_empty.call(null, cljs.core.dissoc.call(null, this.__extmap, b)))
};
mehub.module.twitter.TwitterModule.cljs$core$IPrintable$_pr_seq = function() {
  return cljs.core.list.call(null, "mehub.module.twitter.TwitterModule")
};
mehub.module.twitter.__GT_TwitterModule = function(a) {
  return new mehub.module.twitter.TwitterModule(a)
};
mehub.module.twitter.map__GT_TwitterModule = function(a) {
  return new mehub.module.twitter.TwitterModule("\ufdd0'options".call(null, a), null, cljs.core.dissoc.call(null, a, "\ufdd0'options"))
};
cljs.core._add_method.call(null, mehub.module.load_module, "\ufdd0'twitter", function(a, b) {
  return new mehub.module.twitter.TwitterModule(b)
});
mehub.module.github = {};
mehub.module.github.slugify = function(a) {
  return a.replace(/[-\s]+/, "-").toLowerCase()
};
mehub.module.github.repository_template = function(a) {
  return cljs.core.str.call(null, "<div", hiccups.runtime.render_attr_map.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'id", "\ufdd0'class"], {"\ufdd0'id":null, "\ufdd0'class":cljs.core.str.call(null, "span3  repo", function() {
    var b = "\ufdd0'language".call(null, a);
    return cljs.core.truth_(b) ? cljs.core.str.call(null, " ", mehub.module.github.slugify.call(null, b)) : null
  }(), cljs.core.truth_("\ufdd0'fork".call(null, a)) ? " fork" : null, cljs.core.str.call(null, " c", Math.ceil.call(null, 10 * Math.random.call(null))))})), ">", "<a", hiccups.runtime.render_attr_map.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'href", "\ufdd0'id", "\ufdd0'class"], {"\ufdd0'href":"\ufdd0'html_url".call(null, a), "\ufdd0'id":null, "\ufdd0'class":null})), ">", hiccups.runtime.render_html.call(null, cljs.core.truth_("\ufdd0'fork".call(null, a)) ? cljs.core.PersistentVector.fromArray(["\ufdd0'div.fork-ribbon.icon-random"]) : 
  null), function() {
    var b = "\ufdd0'name".call(null, a);
    return cljs.core.truth_(cljs.core.map_QMARK_.call(null, b)) ? cljs.core.str.call(null, "<h2", hiccups.runtime.render_attr_map.call(null, cljs.core.merge.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'id", "\ufdd0'class"], {"\ufdd0'id":null, "\ufdd0'class":null}), b)), ">", "</h2>") : cljs.core.str.call(null, "<h2>", hiccups.runtime.render_html.call(null, b), "</h2>")
  }(), function() {
    var b = "\ufdd0'language".call(null, a);
    return cljs.core.truth_(cljs.core.map_QMARK_.call(null, b)) ? cljs.core.str.call(null, "<h3", hiccups.runtime.render_attr_map.call(null, cljs.core.merge.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'id", "\ufdd0'class"], {"\ufdd0'id":null, "\ufdd0'class":null}), b)), ">", "</h3>") : cljs.core.str.call(null, "<h3>", hiccups.runtime.render_html.call(null, b), "</h3>")
  }(), function() {
    var b = "\ufdd0'description".call(null, a);
    return cljs.core.truth_(cljs.core.map_QMARK_.call(null, b)) ? cljs.core.str.call(null, "<p", hiccups.runtime.render_attr_map.call(null, cljs.core.merge.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'id", "\ufdd0'class"], {"\ufdd0'id":null, "\ufdd0'class":null}), b)), " />") : cljs.core.str.call(null, "<p>", hiccups.runtime.render_html.call(null, b), "</p>")
  }(), "<span", ' class="meta"', ">", "<span", ' class="watchers"', ">", '<i class="icon-eye-open"></i>', hiccups.runtime.render_html.call(null, "\ufdd0'watchers".call(null, a)), "</span>", "<span", ' class="forks"', ">", '<i class="icon-random"></i>', hiccups.runtime.render_html.call(null, "\ufdd0'forks".call(null, a)), "</span>", "</span>", "</a>", "</div>")
};
mehub.module.github.user_template = function(a) {
  return cljs.core.str.call(null, "<div", ' class="user"', ">", "<h2", "", ">", "<a", hiccups.runtime.render_attr_map.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'href", "\ufdd0'id", "\ufdd0'class"], {"\ufdd0'href":"\ufdd0'html_url".call(null, a), "\ufdd0'id":null, "\ufdd0'class":null})), ">", hiccups.runtime.render_html.call(null, cljs.core.str.call(null, "> ", "\ufdd0'login".call(null, a), "@github")), "</a>", "</h2>", "<div", ' class="info"', ">", "<", "img", hiccups.runtime.render_attr_map.call(null, 
  cljs.core.ObjMap.fromObject(["\ufdd0'src", "\ufdd0'id", "\ufdd0'class"], {"\ufdd0'src":"\ufdd0'avatar_url".call(null, a), "\ufdd0'id":null, "\ufdd0'class":null})), " />", hiccups.runtime.render_html.call(null, "\ufdd0'name".call(null, a)), "</div>", hiccups.runtime.render_html.call(null, function() {
    var b = "\ufdd0'blog".call(null, a);
    return cljs.core.truth_(b) ? cljs.core.PersistentVector.fromArray(["\ufdd0'p.blog", cljs.core.PersistentVector.fromArray(["\ufdd0'i.icon-home"]), cljs.core.PersistentVector.fromArray(["\ufdd0'a", cljs.core.ObjMap.fromObject(["\ufdd0'href"], {"\ufdd0'href":b}), b])]) : null
  }()), hiccups.runtime.render_html.call(null, function() {
    var b = "\ufdd0'bio".call(null, a);
    return cljs.core.truth_(b) ? cljs.core.PersistentVector.fromArray(["\ufdd0'p.bio", cljs.core.PersistentVector.fromArray(["\ufdd0'i.icon-info-sign"]), b]) : null
  }()), hiccups.runtime.render_html.call(null, function() {
    var b = "\ufdd0'company".call(null, a);
    return cljs.core.truth_(b) ? cljs.core.PersistentVector.fromArray(["\ufdd0'p", cljs.core.PersistentVector.fromArray(["\ufdd0'i.icon-cogs"]), b]) : null
  }()), hiccups.runtime.render_html.call(null, function() {
    var b = "\ufdd0'location".call(null, a);
    return cljs.core.truth_(b) ? cljs.core.PersistentVector.fromArray(["\ufdd0'p.location", cljs.core.PersistentVector.fromArray(["\ufdd0'i.icon-map-marker"]), b]) : null
  }()), "</div>")
};
mehub.module.github.activities = function(a) {
  return cljs.core.str.call(null, "<ul", ' class="gh-events"', ">", cljs.core.apply.call(null, cljs.core.str, function() {
    return function c(a) {
      return new cljs.core.LazySeq(null, !1, function() {
        for(;;) {
          if(cljs.core.truth_(cljs.core.seq.call(null, a))) {
            var e = cljs.core.first.call(null, a);
            return cljs.core.cons.call(null, cljs.core.str.call(null, function() {
              var a = cljs.core.str.call(null, e);
              return cljs.core.truth_(cljs.core.map_QMARK_.call(null, a)) ? cljs.core.str.call(null, "<li", hiccups.runtime.render_attr_map.call(null, cljs.core.merge.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'id", "\ufdd0'class"], {"\ufdd0'id":null, "\ufdd0'class":null}), a)), ">", "</li>") : cljs.core.str.call(null, "<li>", hiccups.runtime.render_html.call(null, a), "</li>")
...
mehub.module.github.load_user = function(a, b) {
  return jQuery.getJSON(cljs.core.str.call(null, "https://api.github.com/users/", encodeURIComponent.call(null, a), "?callback=?"), function(a) {
    return b.call(null, cljs.core.js__GT_clj.call(null, a, "\ufdd0'keywordize-keys", !0))
  })
};
mehub.module.github.load_repositories = function(a, b) {
  return jQuery.getJSON(cljs.core.str.call(null, "https://api.github.com/users/", encodeURIComponent.call(null, a), "/repos?callback=?"), function(a) {
    return b.call(null, cljs.core.js__GT_clj.call(null, a, "\ufdd0'keywordize-keys", !0))
  })
};
mehub.module.github.load_activity = function(a, b) {
  return jQuery.getJSON(cljs.core.str.call(null, "https://api.github.com/users/", encodeURIComponent.call(null, a), "/events?&per_page=10&callback=?"), function(a) {
    return b.call(null, cljs.core.js__GT_clj.call(null, a, "\ufdd0'keywordize-keys", !0))
  })
};
mehub.module.github.render_repositories = function(a, b) {
  return jayq.core.inner.call(null, jayq.core.$.call(null, a), clojure.string.join.call(null, " ", cljs.core.map.call(null, mehub.module.github.repository_template, cljs.core.reverse.call(null, cljs.core.sort_by.call(null, "\ufdd0'updated_at", "\ufdd0'data".call(null, b))))))
};
mehub.module.github.render_user = function(a, b) {
  return jayq.core.inner.call(null, jayq.core.$.call(null, a), mehub.module.github.user_template.call(null, "\ufdd0'data".call(null, b)))
};
mehub.module.github.render_activities = function(a, b) {
  return jayq.core.inner.call(null, jayq.core.$.call(null, a), mehub.module.github.activities.call(null, cljs.core.take.call(null, 3, "\ufdd0'data".call(null, b))))
};
mehub.module.github.GitHubModule = function(a, b, c) {
  this.options = a;
  this.__meta = b;
  this.__extmap = c;
  1 < arguments.length ? (this.__meta = b, this.__extmap = c) : this.__extmap = this.__meta = null
};
mehub.module.github.GitHubModule.prototype.cljs$core$IHash$ = !0;
mehub.module.github.GitHubModule.prototype.cljs$core$IHash$_hash = function(a) {
  return cljs.core.hash_coll.call(null, a)
};
mehub.module.github.GitHubModule.prototype.cljs$core$ILookup$ = !0;
mehub.module.github.GitHubModule.prototype.cljs$core$ILookup$_lookup = function() {
  var a = null;
  return function(a, c, d) {
    switch(arguments.length) {
      case 2:
...
mehub.module.github.GitHubModule.prototype.cljs$core$IAssociative$ = !0;
mehub.module.github.GitHubModule.prototype.cljs$core$IAssociative$_assoc = function(a, b, c) {
  return cljs.core.truth_(cljs.core.identical_QMARK_.call(null, "\ufdd0'options", b)) ? new mehub.module.github.GitHubModule(c, this.__meta, this.__extmap) : new mehub.module.github.GitHubModule(this.options, this.__meta, cljs.core.assoc.call(null, this.__extmap, b, c))
};
mehub.module.github.GitHubModule.prototype.cljs$core$IRecord$ = !0;
mehub.module.github.GitHubModule.prototype.cljs$core$ICollection$ = !0;
mehub.module.github.GitHubModule.prototype.cljs$core$ICollection$_conj = function(a, b) {
  return cljs.core.truth_(cljs.core.vector_QMARK_.call(null, b)) ? cljs.core._assoc.call(null, a, cljs.core._nth.call(null, b, 0), cljs.core._nth.call(null, b, 1)) : cljs.core.reduce.call(null, cljs.core._conj, a, b)
};
mehub.module.github.GitHubModule.prototype.mehub$module$PModule$ = !0;
mehub.module.github.GitHubModule.prototype.mehub$module$PModule$setup = function() {
  mehub.module.github.load_repositories.call(null, "\ufdd0'user".call(null, this.options), cljs.core.partial.call(null, mehub.module.github.render_repositories, "\ufdd0'repo-selector".call(null, this.options)));
  return mehub.module.github.load_user.call(null, "\ufdd0'user".call(null, this.options), cljs.core.partial.call(null, mehub.module.github.render_user, "\ufdd0'user-selector".call(null, this.options)))
};
mehub.module.github.GitHubModule.prototype.cljs$core$ISeqable$ = !0;
mehub.module.github.GitHubModule.prototype.cljs$core$ISeqable$_seq = function() {
  return cljs.core.seq.call(null, cljs.core.concat.call(null, cljs.core.PersistentVector.fromArray([cljs.core.vector.call(null, "\ufdd0'options", this.options)]), this.__extmap))
};
mehub.module.github.GitHubModule.prototype.cljs$core$IPrintable$ = !0;
mehub.module.github.GitHubModule.prototype.cljs$core$IPrintable$_pr_seq = function(a, b) {
  return cljs.core.pr_sequential.call(null, function(a) {
    return cljs.core.pr_sequential.call(null, cljs.core.pr_seq, "", " ", "", b, a)
  }, cljs.core.str.call(null, "#", "mehub.module.github.GitHubModule", "{"), ", ", "}", b, cljs.core.concat.call(null, cljs.core.PersistentVector.fromArray([cljs.core.vector.call(null, "\ufdd0'options", this.options)]), this.__extmap))
};
mehub.module.github.GitHubModule.prototype.cljs$core$ICounted$ = !0;
mehub.module.github.GitHubModule.prototype.cljs$core$ICounted$_count = function() {
  return 1 + cljs.core.count.call(null, this.__extmap)
};
mehub.module.github.GitHubModule.prototype.cljs$core$IEquiv$ = !0;
mehub.module.github.GitHubModule.prototype.cljs$core$IEquiv$_equiv = function(a, b) {
  var c = a.constructor === b.constructor;
  return cljs.core.truth_(c) ? cljs.core.equiv_map.call(null, a, b) : c
};
mehub.module.github.GitHubModule.prototype.cljs$core$IWithMeta$ = !0;
mehub.module.github.GitHubModule.prototype.cljs$core$IWithMeta$_with_meta = function(a, b) {
  return new mehub.module.github.GitHubModule(this.options, b, this.__extmap)
};
mehub.module.github.GitHubModule.prototype.cljs$core$IMeta$ = !0;
mehub.module.github.GitHubModule.prototype.cljs$core$IMeta$_meta = function() {
  return this.__meta
};
mehub.module.github.GitHubModule.prototype.cljs$core$IMap$ = !0;
mehub.module.github.GitHubModule.prototype.cljs$core$IMap$_dissoc = function(a, b) {
  return cljs.core.truth_(cljs.core.contains_QMARK_.call(null, cljs.core.set(["\ufdd0'options"]), b)) ? cljs.core.dissoc.call(null, cljs.core.with_meta.call(null, cljs.core.into.call(null, cljs.core.ObjMap.fromObject([], {}), a), this.__meta), b) : new mehub.module.github.GitHubModule(this.options, this.__meta, cljs.core.not_empty.call(null, cljs.core.dissoc.call(null, this.__extmap, b)))
};
mehub.module.github.GitHubModule.cljs$core$IPrintable$_pr_seq = function() {
  return cljs.core.list.call(null, "mehub.module.github.GitHubModule")
};
mehub.module.github.__GT_GitHubModule = function(a) {
  return new mehub.module.github.GitHubModule(a)
};
mehub.module.github.map__GT_GitHubModule = function(a) {
  return new mehub.module.github.GitHubModule("\ufdd0'options".call(null, a), null, cljs.core.dissoc.call(null, a, "\ufdd0'options"))
};
cljs.core._add_method.call(null, mehub.module.load_module, "\ufdd0'github", function(a, b) {
  return new mehub.module.github.GitHubModule(b)
});
mehub.core = {};
mehub.core.init = function(a) {
  var a = cljs.core.js__GT_clj.call(null, a, "\ufdd0'keywordize-keys", !0), b = cljs.core.seq.call(null, "\ufdd0'modules".call(null, a));
  if(cljs.core.truth_(b)) {
    a = cljs.core.first.call(null, b);
    cljs.core.nth.call(null, a, 0, null);
    for(cljs.core.nth.call(null, a, 1, null);;) {
      var c = a, d = cljs.core.nth.call(null, c, 0, null), e = cljs.core.nth.call(null, c, 1, null), f = b, g = mehub.module.load_module.call(null, d, e);
      mehub.module.setup.call(null, g, function() {
        return function() {
          return null
        }
      }(a, b, g, c, d, e, f));
